  ...
  head: () => ({
    meta: [
      { title: "F1 Grand Prix Screening — AWS SBG VITB, AB-02" },
      {
        name: "description",
        content:
          "Lights out at VIT Bhopal. AWS SBG VITB screens the Formula 1 Grand Prix live across AB02-127 & AB02-126 — 576 seats, tiered pricing from ₹99, book your seat now.",
      },
      { property: "og:title", content: "F1 Grand Prix Screening — AWS SBG VITB" },
      {
        property: "og:description",
        content:
          "576 seats, two rooms, big screens and full race weekend energy in AB-02. Pick your seat from ₹99.",
      },
